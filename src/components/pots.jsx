...
const categories = [
  { key: 'ceramic', name: 'Ceramic pots' },
  { key: 'plastic', name: 'Plastic pots' },
  { key: 'hanging', name: 'Hanging planters' },
  { key: 'selfWatering', name: 'Self watering pots' },
  { key: 'decorative', name: 'Decorative planters' },
];

function AnimatedProductCard({ product, index, activeCategory }) {
...
function Pots() {
  ...
  const products = potsData[activeCategory];
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen">
      ...
      <main className="w-full lg:w-3/4 p-6 text-center">
        <h1 className="text-2xl sm:text-4xl font-bold mb-2 text-green-800">Pots & Planters</h1>
