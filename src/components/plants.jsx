...
const categories = [
  { key: 'indoor', name: 'Indoor Plants' },
  { key: 'outdoor', name: 'Outdoor Plants' },
  { key: 'fruit', name: 'Fruit Trees' },
  { key: 'succulents', name: 'Cacti & Succulents' },
  { key: 'air', name: 'Air Purifying Plants' },
  { key: 'flowering', name: 'Flowering Plants' },
...
function Plants() {
  ...
  const products = plantsData[activeCategory];
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen ">
      ...
      <main className="w-full lg:w-3/4 p-6 text-center">
        <h1 className="text-2xl sm:text-4xl font-bold mb-2 text-green-800">Plants</h1>
